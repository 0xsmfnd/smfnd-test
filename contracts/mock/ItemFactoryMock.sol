...
contract ItemFactoryMock is ERC1155SupplyCC, AccessControl {
    ...
    function claim(address claimer, uint256 entropy, uint256 rewardRarity, uint256 rewardType, uint256 rewardAmount) external {
        ...
        // handle MILK or ITEMS
            ...
            if (lastUpdateForID == 0) lastUpdateForID = block.timestamp + 86400;
