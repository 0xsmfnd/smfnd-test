...
interface MilkInterface extends ethers.utils.Interface {
  ...
  events: {
    ...
    "GameBurn(address,uint256)": EventFragment;
    "GameMint(address,uint256)": EventFragment;
    "GameTransferFrom(address,address,uint256)": EventFragment;
    "GameWithdraw(address,uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "GameBurn"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "GameMint"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "GameTransferFrom"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "GameWithdraw"): EventFragment;
